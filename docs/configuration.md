...
This document also owns every `config/` file's meaning, default, and inheritance, either in its own section below or through the backend guide or skill that section names.
